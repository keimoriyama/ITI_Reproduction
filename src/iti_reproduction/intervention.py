...
def intervene(cfg: ITIConfig):
    ...
    for i in range(cfg.num_fold):
        ...
        curr_fold_results = alt_tqa_evaluate(
            ...
            metric_names=["judge", "mc", "bleu", "rouge", "bleurt"],
            # metric_names=["bleurt"],
    ...
    print(
        f"alpha: {cfg.alpha}, heads: {cfg.num_heads_to_intervene}, True*Info Score: {final[1] * final[0]}, True Score: {final[1]}, Info Score: {final[0]}, MC1 Score: {final[2]}, MC2 Score: {final[3]}"
    )
